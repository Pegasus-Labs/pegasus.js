...
const perpetual1: PerpetualStorage = {
  ...
  openSlippageLongPenaltyFactor: { value: new BigNumber(1), minValue: _0, maxValue: _0 },
  openSlippageShortPenaltyFactor: { value: new BigNumber(1), minValue: _0, maxValue: _0 },
