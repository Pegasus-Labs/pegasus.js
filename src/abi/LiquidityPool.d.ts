...
interface LiquidityPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "updatePerpetualRiskParameter(uint256,int256[6])": FunctionFragment;
...
export class LiquidityPool extends Contract {
  ...
  functions: {
    ...
    "createPerpetual(address,int256[9],int256[6],int256[6],int256[6])"(
      oracle: string,
      coreParams: [
        BigNumberish,
        BigNumberish,
    ...
    "initialize(address,address,uint256,address,address,bool)"(
      operator: string,
      collateral: string,
      collateralDecimals: BigNumberish,
      governor: string,
    ...
    "setPerpetualRiskParameter(uint256,int256[6],int256[6],int256[6])"(
      perpetualIndex: BigNumberish,
      riskParams: [
        BigNumberish,
        BigNumberish,
    ...
    "updatePerpetualRiskParameter(uint256,int256[6])"(
      perpetualIndex: BigNumberish,
      riskParams: [
        BigNumberish,
        BigNumberish,
